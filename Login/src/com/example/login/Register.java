...
public class Register extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Register.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(Password.getText().toString().length()<1 || Username.getText().toString().length()<1){
					// out of range
					Toast.makeText(Register.this, "Nie wpisano danych!", Toast.LENGTH_LONG).show();
				}
				else{
	...
	private class MyAsyncTaskRegister extends AsyncTask<String,Integer,Void>{
		...
		protected void onPostExecute(Void result) {
			// TODO Auto-generated method stub
			pb.setVisibility(View.GONE);
			Toast.makeText(getApplicationContext(), "Dane do rejestracji zosta³y wys³ane!", Toast.LENGTH_LONG).show();
		}
		...
		private void postData(String pass,String un) throws NoSuchAlgorithmException {
			// TODO Auto-generated method stub
			// Create a new HttpClient and Post Header
						HttpClient httpclient = new DefaultHttpClient();
						HttpPost httppost = new HttpPost("http://mandrusz.pusku.com/include/insert.php");
