...
public class ChartFromButton2 extends Activity
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        // y-vals to plot:
        Number[] series1Numbers = {1,2,1,1,1,1,1,2,2,2,2,1,1,1,2,2,1};
        ...
        mySimpleXYPlot.setRangeBoundaries(1, BoundaryMode.FIXED, 3, BoundaryMode.FIXED);
       ...
       //mySimpleXYPlot.getGraphWidget().getDomainGridLinePaint().setAlpha(0);
      


        // get rid of decimal points in our domain labels:
        mySimpleXYPlot.setDomainValueFormat(new DecimalFormat("0"));
        //mySimpleXYPlot.getGraphWidget().setDrawMarkersEnabled(false);
